            ...
            <div className="text-white p-2">
                <div className="grid grid-cols-1 overflow-hidden">
                    <div className="grid grid-rows-4 gap-y-2  ">
                        ...
                        <p className="text-sm text-ellipsis overflow-hidden">{info.description}</p>
                        ...
                        <div className="flex gap-5 ">
                            {
                                links.length > 0 && links.map((data) => (
                                    <a href={data.path} target="_blank" className="bg-cardBg text-sm text-secondary cursor-pointer hover:text-accent flex items-center gap-2">
